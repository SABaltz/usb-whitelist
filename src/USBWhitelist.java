...
public class USBWhitelist {
    ...
    static class FileManager {
        static void checkWhiteListFileExistence() {
    ...
    static class USBManager {
        ...
        static List<String> listConnectedUSBs() {
        ...
        static boolean isWhitelisted(File deviceFile) {
    ...
    static class WhitelistManager {
        static void modifyWhitelist(String usbId, boolean add) {
            try {
